...
public class RunMVC {
    ...
    public RunMVC() {
        ...
        GUIBusquedaClientes myView = new GUIBusquedaClientes(400, 40);
        
        GUIClientesProfesion myView2 = new GUIClientesProfesion(400,220);
        
        GUIEstadisticaPorSexo myView3 = new GUIEstadisticaPorSexo(20,360);
        
        GUIEstadisticaPorSexoGrafica myView4 = new GUIEstadisticaPorSexoGrafica(800,360);
